...
canvas.addEventListener('mousedown', (e) => {
    ...
    // Инструмент "Размер" перенесён в index.html
        ...
        console.log('   Текущий шаг:', !isDrawing ? '1 (вершина)' : (!dimensionStartPoint.secondPoint ? '2 (первая точка)' : '3 (вторая точка)'));
        ...
        if (!isDrawing) {
            ...
            dimensionLabel.textContent = '📐 Кликните на вторую точку';
