...
const _MJ_LOG = true;
function _mjLog(...args) { if (_MJ_LOG) console.log('[MICROJOINT]', ...args); }
            ...
            if (typeof appState !== 'undefined' && appState.allSheets) {
                ...
                if (invalidated > 0) {
                    ...
                    if (typeof alert !== 'undefined') {
                        console.warn('⚠️ [MICROJOINT] Геометрия детали изменилась. Рекомендуется выполнить раскладку заново для корректной проверки коллизий.');
                    }
                }
            }
