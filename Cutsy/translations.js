...
const TRANSLATIONS = {
    ...
    en: {
        ...
        alert_license_not_set: '⚠️ License server not configured. Contact developer.',
        alert_license_no_connection: '❌ No connection to license server. Check internet.',
        alert_license_offline: '✅ License confirmed (offline mode)',
        
        // Account system
        account_login_title: '🔐 Login',
        account_register_title: '📝 Register',
        account_activate_title: '🔑 Activate License',
        ...
        account_activate_btn: 'Activate',
        account_logout_btn: 'Logout',
        account_no_account: 'No account?',
        account_has_account: 'Already have an account?',
        account_buy_pro: 'Buy PRO',
        account_enter_key: 'Enter license key',
        account_status_active: '✅ License active',
        account_status_inactive: '❌ No active license',
        account_device_limit: '❌ Device limit exceeded',
        account_remove_device: '🗑️ Remove old device',
        account_max_devices: 'Maximum devices reached',
    ...
    ru: {
        ...
        btn_nesting_all: '📑 Разложить',
        btn_nesting_current: '📑 Разложить (текущий)',
        ...
        alert_nesting_required: 'Сначала выполните раскладку (кнопка "📑 Разложить")',
        alert_license_not_set: '⚠️ Сервер лицензий не настроен. Обратитесь к разработчику.',
        alert_license_no_connection: '❌ Нет соединения с сервером лицензий. Проверьте интернет.',
        alert_license_offline: '✅ Лицензия подтверждена (автономный режим)',
        
        // Аккаунтная система
        account_login_title: '🔐 Вход в систему',
        account_register_title: '📝 Регистрация',
        account_activate_title: '🔑 Активация лицензии',
        account_email_label: 'Email',
        account_password_label: 'Пароль',
        account_password_confirm_label: 'Повторите пароль',
        account_login_btn: 'Войти',
        account_register_btn: 'Зарегистрироваться',
        account_activate_btn: 'Активировать',
        account_logout_btn: 'Выйти',
        account_no_account: 'Нет аккаунта?',
        account_has_account: 'Уже есть аккаунт?',
        account_buy_pro: 'Купить PRO',
        account_enter_key: 'Введите лицензионный ключ',
        account_status_active: '✅ Лицензия активна',
        account_status_inactive: '❌ Нет активной лицензии',
        account_device_limit: '❌ Лимит устройств превышен',
        account_remove_device: '🗑️ Удалить старое устройство',
        account_max_devices: 'Достигнут лимит устройств',
