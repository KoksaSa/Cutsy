...
### Рисование деталей
![Рисование деталей и установка размеров](screenshots/Рисование деталей и установка размеров.png)

### Раскладка на листе
![Раскладка деталей и инструменты редактирования](screenshots/Раскладка деталей и иструменты редактирования деталей на листе.png)

### Импорт деталей
![Массовый импорт деталей с присвоением толщины и количества](screenshots/массовы импорт делатей с присовением толщены и количества из названия файла.png)

### Отчёт о раскладке
![Отчёт о разложенных деталях на листе](screenshots/Отчет о разложенных деталях на листе.png)

### Отчёт о детали
![Отчёт о нарисованной детали](screenshots/Отчет о нарисованной детали согласно установленным данным листа.png)

### Выбор листа
![Выбор листа и загрузка своего остатка](screenshots/Выбор листа и загрузка совоего остатка.png)

### Меню редактирования
![Меню редактирования](screenshots/меню редактирования.png)
